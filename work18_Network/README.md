...
```
                                                 ...
                                                 +---+  eth5:192.168.254.1/30 - router-net                           |
                                                 |      eth6:192.168.253.1/30 - router-net +------------------------------------------------------+                                                          |
                                                 |                                                                   |                            |
        				         |              					             |                            |
                                                 |                                                                   |                            |
        			                 |              					             |                            |
 ...
 |  eth4:192.168.2.193/26 - office-hardware      |                                        eth4:192.168.253.2/30 - router-net +--------------------+
 |  eth5:192.168.254.2/30 - router-net-----------+					                                             |
 | 							                                                                             |
 |								                                                                     |                         
 |								                                                                     |
 |								                                                                     |
 ...
 +-------+ eth1:192.168.2.2/26 - servers					           eth1:192.168.1.2/25 - servers +-----------+
