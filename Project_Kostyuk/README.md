...
<code>Смысл в чем, что бы при случае возникновения аварии "web" будь то проблемы с бд  или с конфигурационными файлами или еще с чем то, можно таким образом восстановить работоспособность
данного ресурса, путем подмены файлов</code>
